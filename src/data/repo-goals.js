...
// Rời mục tiêu (mục tiêu opt-in): xoá bản đóng góp của mình.
export async function removeMyGoalProgress(goalId, uid) {
  await deleteDoc(doc(db, 'goals', goalId, 'progress', uid));
}
