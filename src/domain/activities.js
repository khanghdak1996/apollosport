...
export const ACTIVITIES = [
  { id: 'gym', emoji: '🏋️',        label: 'Tập gym',    icon: 'dumbbell', kind: 'strength', met: 5.0, color: '#6366f1', verb: 'đã hoàn thành buổi' },

  { id: 'run', emoji: '🏃', label: 'Chạy bộ', icon: 'run', kind: 'distance', met: 9.0, color: '#f97316', verb: 'đã chạy', laps: true, fields: [
    DUR,
  ...
  { id: 'walk', emoji: '🚶', label: 'Đi bộ', icon: 'walk', kind: 'distance', met: 3.5, color: '#84cc16', verb: 'đã đi bộ', fields: [
    DUR,
    { k: 'distanceKm', label: 'Quãng đường (km)', type: 'number', unit: 'km' },
    { k: '_pace', label: 'Pace', type: 'pace', mode: 'km' },
    INTENSITY,
  ...
  { id: 'cycle', emoji: '🚴', label: 'Đạp xe', icon: 'bike', kind: 'distance', met: 7.5, color: '#06b6d4', verb: 'đã đạp xe', laps: true, fields: [
    DUR,
    { k: 'distanceKm', label: 'Quãng đường (km)', type: 'number', unit: 'km' },
  ...
  { id: 'swim', emoji: '🏊', label: 'Bơi', icon: 'swim', kind: 'distance', met: 7.0, color: '#0ea5e9', verb: 'đã bơi', laps: true, fields: [
    DUR,
  ...
  { id: 'hiking', emoji: '🥾', label: 'Leo núi', icon: 'mountain', kind: 'distance', met: 6.0, color: '#78716c', verb: 'đã leo núi', fields: [
    DUR,
    { k: 'distanceKm', label: 'Quãng đường (km)', type: 'number', unit: 'km' },
  ...
  { id: 'yoga', emoji: '🧘', label: 'Yoga', icon: 'yoga', kind: 'session', met: 3.0, color: '#a855f7', verb: 'đã tập yoga', fields: [
    DUR,
  ...
  { id: 'football', emoji: '⚽', label: 'Bóng đá', icon: 'ball', kind: 'session', met: 8.0, color: '#22c55e', verb: 'đã chơi bóng đá', fields: [
    DUR,
    { k: 'periods', label: 'Số hiệp', type: 'counter', def: 0, max: 20 },
    INTENSITY,
  ] },

  { id: 'basketball', emoji: '🏀', label: 'Bóng rổ', icon: 'ball', kind: 'session', met: 6.5, color: '#ef4444', verb: 'đã chơi bóng rổ', fields: [
    DUR,
    { k: 'periods', label: 'Số hiệp', type: 'counter', def: 0, max: 20 },
    INTENSITY,
  ] },

  { id: 'badminton', emoji: '🏸', label: 'Cầu lông', icon: 'racket', kind: 'session', met: 5.5, color: '#eab308', verb: 'đã chơi cầu lông', fields: [
    DUR,
    { k: 'games', label: 'Số ván', type: 'counter', def: 0, max: 30 },
    INTENSITY,
  ] },

  { id: 'tennis', emoji: '🎾', label: 'Tennis', icon: 'racket', kind: 'session', met: 7.3, color: '#f59e0b', verb: 'đã chơi tennis', fields: [
    DUR,
    { k: 'games', label: 'Số ván (set)', type: 'counter', def: 0, max: 30 },
    INTENSITY,
  ] },

  { id: 'pickleball', emoji: '🥒', label: 'Pickleball', icon: 'racket', kind: 'session', met: 5.0, color: '#14b8a6', verb: 'đã chơi pickleball', fields: [
    DUR,
    { k: 'games', label: 'Số ván', type: 'counter', def: 0, max: 30 },
    INTENSITY,
  ] },

  { id: 'other', emoji: '✨', label: 'Khác', icon: 'spark', kind: 'session', met: 4.0, color: '#64748b', verb: 'đã tập' },
];
