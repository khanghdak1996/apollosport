...
export function Settings({ profile, onSave, onBack, onSignOut, onDeleteAccount, onRecalcStreak, onClearHistory }) {
    ...
    <div style=${{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style=${{ flex: 1, overflowY: 'auto', padding: '18px 16px 40px' }}>
        ...
        <${Panel}>
          ...
          <${Row} t="Chế độ quản trị" s="Bật để kiểm duyệt bài & bình luận vi phạm của người khác" on=${moderating} onToggle=${() => setModerating(!moderating)}/>
        </${Panel}>
